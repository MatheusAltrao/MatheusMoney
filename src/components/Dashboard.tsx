...
const Dashboard = () => {
    ...
    return (
        <div className='w-full mt-20 rounded-lg flex items-center justify-between gap-4 '>
            <div className='w-full h-[8.5rem] bg-zinc-900 rounded px-8 py-6'>
            ...
            <div
                className={`w-full h-[8.5rem]  rounded transition-colors px-8 py-6 ${
